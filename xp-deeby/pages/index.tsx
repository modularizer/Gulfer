...
import { listDatabasesWeb, registerDatabaseName, getDatabaseMetadata, deleteDatabaseByName, type DatabaseMetadata } from '../adapters';
...
export default function XpDeebyDatabaseList() {
