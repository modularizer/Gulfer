...
export const venueFormatStag = table('venue_format_stages', {
    ...baseColumns,
...
// ============================================================================
// Event Formats (replaces Courses)
// ============================================================================

export const eventFormats = sqliteTable('event_formats', {
    ...baseColumns,
    sportId: text('sport_id').notNull().references(() => sports.id, { onDelete: 'cascade' }),
    numberOfStages: integer('number_of_stages'),
});
