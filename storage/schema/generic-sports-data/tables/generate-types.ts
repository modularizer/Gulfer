...
const PROJECT_ROOT = path.join(__dirname, '../../../../'); // tables -> generic-sports -> sports -> storage -> root
...
function generateTypes(): void {
  console.log('🔍 Analyzing generic-sports files with ts-morph...');
  ...
  // Add the generic-sports types file
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Match: export type TypeName = typeof generic-sports.tableName.$inferSelect;
    ...
    // Match: export type TypeNameInsert = typeof generic-sports.tableName.$inferInsert;
