...
import type { EventScoringInfo, SimpleGroupResult, SimplePlayerResult, ValueToScoreType, StageMetadata } from '../../schema/scoring';
import type { EventStage } from '../../schema/tables';
import { z } from 'zod';
