...
const PROJECT_ROOT = path.join(__dirname, '../../..'); // tables -> schema -> src -> root
      ...
      for (let j = i + 1; j < lines.length && j < i + 3; j++) {
        ...
        if (nextLine.includes('//')) {
          if (nextLine.includes('Sports and Formats')) {
            ...
            break;
          } else if (nextLine.includes('Accounts')) {
            currentSection = 'accounts';
            break;
          } else if (nextLine.includes('Settings')) {
            currentSection = 'settings';
            break;
          } else if (nextLine.includes('Data Merges')) {
            currentSection = 'data-merges';
            break;
          }
        }
      }
 ...
 * 
 * This file is auto-generated by src/schema/tables/generate-types.ts
