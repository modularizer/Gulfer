...
export default [
  {
    name: '0000_elite_plazm',
    hash: 'c53377e7517fbd03',
    sql: `CREATE TABLE \`setting_options\` (
...
CREATE TABLE \`account_setting_options\` (
    ...
    postgres: `CREATE TABLE "setting_options" (
	"id" text PRIMARY KEY NOT NULL,
	"name" text,
	"spec" text
);
...
CREATE TABLE "account_setting_options" (
  ...
  {
    name: '0000_famous_skullbuster',
    hash: '3d573906d31ded54',
    sql: `CREATE TABLE \`event_format_stages\` (
	\`id\` text PRIMARY KEY NOT NULL,
	\`name\` text,
	\`notes\` varchar(200),
	\`lat\` real,
...
CREATE UNIQUE INDEX \`merge_entries_foreign_storage_id_foreign_id_unique\` ON \`merge_entries\` (\`foreign_storage_id\`,\`foreign_id\`);`,
    postgres: `CREATE TABLE "event_format_stages" (
	"id" text PRIMARY KEY NOT NULL,
	"name" text,
	"notes" varchar(200),
	"lat" real,
