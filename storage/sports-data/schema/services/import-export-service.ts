...
export class ImportExportService extends BaseService {
  ...
  async exportData(options: ExportOptions = {}): Promise<ExportData> {
    ...
    const allTables = [
      ...
      { name: 'accounts', table: accountSchema.accounts },
      { name: 'account_setting_options', table: accountSchema.accountSettingOptions },
    ];
  ...
  private getTableByName(tableName: string): any {
    const tableMap: Record<string, any> = {
      ...
      'account_setting_options': accountSchema.accountSettingOptions,
