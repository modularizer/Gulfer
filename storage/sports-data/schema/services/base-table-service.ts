...
export abstract class BaseTableService<T extends BaseColumns> extends BaseService {
  ...
  async updateBaseColumns(
    ...
    await upsertEntity(this.db, table, updated);
  ...
  async addPhoto(
    ...
    await upsertEntity(this.db, schema.photos, photo);
  ...
  async updatePhoto(
    ...
    await upsertEntity(this.db, schema.photos, updated);
