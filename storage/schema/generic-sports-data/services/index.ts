 ...
 * Schema Services
 * 
 * Object-oriented services for managing all generic-sports entities.
 * These services provide high-level, type-safe APIs for common operations.
 * 
 * Usage:
 * ```ts
 * import { getDatabase } from '@services/storage/db';
 * import { PlayerService, TeamService, EventService } from '@/sports-storage/generic-sports/services';
 * 
...
export { SportRegistryService } from './sport-registry-service';
